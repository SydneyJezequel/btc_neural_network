...
display_results.evaluate_initial_model(trained_model, test_loader, scaler, feature_cols, target_col_idx, window_width=45, start_index=70, pred_length=1, device=device)
