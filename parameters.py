...
MODEL_PATH = '../model/'
TRAINING_DAILY_DATASET_FILE = DATASET_PATH + 'btc_daily_historic_cotations.csv'
TRAINING_HOURLY_DATASET_FILE = DATASET_PATH + 'btc_hourly_historic_cotations.csv'
...
API_MONSTER_KEY = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX'
