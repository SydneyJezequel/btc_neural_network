...
X_train = train_data.drop(columns=['Dernier', 'Date']).values
y_train = train_data['Dernier'].values
X_test = test_data.drop(columns=['Dernier', 'Date']).values
